  ...
  return (
    <main className="magnetic-main z-4 bg-[#fff]">
      ...
      <div className="magnetic-container">
          <IconsMagnetic>
            <a href={`https://www.facebook.com/share_channel/?link=https%3A%2F%2Flinktr.ee%2Fbagditravel%3Futm_source%3Dlinktree_profile_share&app_id=966242223397117&source_surface=external_reshare&display&hashtag`}>
          ...
          <IconsMagnetic>
          <a href={`https://youtube.com/idobagdi`}>
