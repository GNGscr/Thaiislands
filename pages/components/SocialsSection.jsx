  ...
  return (
    <main className="magnetic-main z-4 bg-[#fff]">
      ...
      <div className="magnetic-container">
        <IconsMagnetic>
          <a target="_blank" rel="noopener noreferrer" href={`https://www.facebook.com/daniel.ehrlich.98/`}>
        ...
        <IconsMagnetic>
          <a target="_blank" rel="noopener noreferrer" href={`https://www.instagram.com/daniel__ehrlich`}>
        ...
        <IconsMagnetic>
          <a target="_blank" rel="noopener noreferrer" href={`https://linktr.ee/`}>
