  ...
  return (
    <div className="bg-white main">
      ...
      <div className={`relative h-[${
          media === 'desktop'? '120' : '60'}${media === 'desktop' ? 'vh' : '%'}]`
          }>
...
const TextParallaxContentComponent = ({
  ...
  return (
    ...
    >
      <div className={`relative h-[150${media === 'desktop' ? 'vh' : '%'}]`} id={`${isMapVisible ? 'map-img' : ''}`}>
  ...
  if (!imgUrl) return '';
    ...
    <motion.div
      style={{
        ...
        height: `calc(100${media === 'desktop' ? 'vh' : '%'} - ${IMG_PADDING * 2}px)`,
        top: IMG_PADDING,
        scale
      }}
      ref={targetRef}
