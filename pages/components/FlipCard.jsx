    ...
    <div className="flex items-center justify-center">
        <div className="flip-card w-[352px] h-[294.42px] rounded-md" onClick={handleFlip}>
            ...
            >
              ...
              >
                <img src={image} width="100" height="100" alt="img" className="w-[100%] h-[100%] rounded-[6px] absolute top-0 left-0 z-1" />
                <div className="card-front-mask" />
                <div className="stars-wrapper flex gap-[0.1rem] z-2 absolute top-5 left-5">
                  {
                ...
                <div className="front-hotel-name-wrapper">
              ...
              <div 
                ...
                className={`flip-card-back w-[100%] h-[100%] bg-cover
                  ...
                  `}
                  >
                <img src={image}  alt="img" className="flip-card-back-img w-[100%] h-[100%] rounded-[6px] absolute top-0 left-0 z-1" />
                  ...
                  <div className="card-content">{content}</div>
                    <div className="score-wrapper">
                      ...
                      <div className="google-score">
                        <div>{googleScore}</div>
                        <div>-</div>
                        <div>{lang === 'he' ? 'ציון גוגל' : 'Google Score'}</div>
                      </div>
                      ...
                      <div className="star-score flex gap-[0.25rem]">
                        {
                          [...Array(numOfStars)].map((star, i) => {
                            return (
                              <svg key={i} xmlns="http://www.w3.org/2000/svg" viewBox="0 0 36 34" width="13" height="13" id="star">
                    ...
                    <motion.a 
                      ...
                      variants={{
                        initial: { scale: 1 },
                        animate: { scale: 1.04, transition: { duration: .2, type: "spring" } }
                      }}
                      >
                          {ctaButtonLang[lang]}
                    </motion.a>
