      ...
      >
        <div className="inner-navbar w-screen flex align-space-between justify-center text-white">
          <div className={`social flex gap-4 ml-7 mt-1 ${pathname === '/about-us' || pathname === '/' ? 'invisible' : 'visible'}`}>
            <a href="https://www.instagram.com/" style={ !!color ? { color: color.current } : {}} target="_blank" rel="noopener noreferrer">
              <svg data-name="instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="cursor-pointer" style={{ width: '30px', marginTop: '0.35rem' }}>
            ...
            <a href="https://facebook.com" style={ !!color ? { color: color.current} : {}} target="_blank" rel="noopener noreferrer">
  ...
  return (
    <ul
      ...
      className={`navbar-ul mx-auto rounded-full gap-3 p-1
        ${pathname === '/about-us' || pathname === '/' ? 'invisible' : 'visible'}`}
    >
      {
