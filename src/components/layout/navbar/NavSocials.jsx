...
export default function NavSocials({ pathname }) {
  ...
  return (
    <div className={`${styles.social} ${hidden}`} style={{ height: "fit-content" }}>
      <motion.a href="https://www.instagram.com/daniel__ehrlich/" style={{ color }} target="_blank" rel="noopener noreferrer">
        ...
        <svg data-name="instagram" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" fill="currentColor" className="cursor-pointer"
              style={{ width: '30px', marginTop: '0.75rem' }}>
      ...
      <motion.a href="https://facebook.com" style={{ color }} target="_blank" rel="noopener noreferrer">
        {/* Facebook SVG */}
        <svg data-name="facebook" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 31.5 58" fill="currentColor" className="cursor-pointer" style={{ width: '22px', marginTop: '0.4rem', transform: "scale(0.65)" }}>
