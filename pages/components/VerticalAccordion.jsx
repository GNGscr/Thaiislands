...
const VerticalAccordion = () => {
  ...
  return (
    <section className="p-4 bg-black">
      <div className="flex flex-col lg:flex-row h-fit lg:h-[450px] w-full max-w-6xl mx-auto overflow-hidden">
        {items ? 
          items.map((item) => {
            return (
              <Panel
...
export const Panel = ({ open, setOpen, id, title, imgSrc, description }) => {
